...
function destructivelyRemoveLastCat(name){return cats.pop(name)};
function destructivelyRemoveFirstCat(name){return cats.shift(name)};
function appendCat(name){return [...cats,name]};
function prependCat(name){return [name, ...cats]}
function removeLastCat(name){return cats.slice(0,-1)};
